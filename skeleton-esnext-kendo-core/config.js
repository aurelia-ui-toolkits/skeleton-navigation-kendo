System.config({
  ...
  paths: {
    ...
    "kendo-ui/*": "jspm_packages/github/kendo-labs/bower-kendo-ui@2016.2.630/js/*",
    "kendo.*": "jspm_packages/github/kendo-labs/bower-kendo-ui@2016.2.630/js/kendo.*.js"
  },
  meta: {
    "bootstrap": {
      "deps": [
  ...
  map: {
    ...
    "aurelia-kendoui-bridge": "npm:aurelia-kendoui-bridge@0.11.8",
    ...
    "npm:aurelia-kendoui-bridge@0.11.8": {
      "aurelia-binding": "npm:aurelia-binding@1.0.0-rc.1.0.2",
      "aurelia-dependency-injection": "npm:aurelia-dependency-injection@1.0.0-rc.1.0.0",
      "aurelia-logging": "npm:aurelia-logging@1.0.0-rc.1.0.0",
      "aurelia-metadata": "npm:aurelia-metadata@1.0.0-rc.1.0.0",
